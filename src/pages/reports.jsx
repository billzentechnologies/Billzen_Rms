...
const Reports = () => {
  ...
  // Fetch sales summary whenever date range is set (for Item-wise Sales Summary at end of report)
  useEffect(() => {
  ...
  const fetchSalesSummary = async () => {
    ...
    try {
      const data = await getSalesSummary(filters.fromDate, filters.toDate);
