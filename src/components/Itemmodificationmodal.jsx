...
const ItemModificationModal = ({ isOpen, onClose, item, onVoidItem, onComplimentaryItem }) => {
  ...
  const handleConfirm = () => {
    if (!reason || reason.trim() === '') {
      alert('⚠️ Please provide a reason for void');
      return;
    }
  ...
  const headerHoverColor = 'hover:bg-gray-700';
        ...
        <div className="p-6">
          ...
          <div className="mb-6">
            ...
            <textarea
              ...
              placeholder="Please provide reason (e.g., customer request, wrong item, promotional offer)"
          ...
          <div className="flex space-x-2">
            ...
            <button
              ...
              disabled={!reason || reason.trim() === ''}
              className="flex-1 py-3 rounded transition-colors font-medium flex items-center justify-center gap-2 bg-red-600 text-white hover:bg-red-700 disabled:bg-gray-400 disabled:cursor-not-allowed"
            >
              Void ({quantity})
            </button>
          </div>
